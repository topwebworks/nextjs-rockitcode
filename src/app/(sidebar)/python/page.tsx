...
export const metadata: Metadata = {
  title: "Python Programming - RockitCode",
...
export default async function PythonPage() {
  const course = await getRockitCourse("python");
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative">
            ...
            <div className="px-4 pt-48 pb-12 lg:py-24">
              ...
              <div className="mt-10">
                <Link
                  href={`/learn/python/${course.milestones[0].lessons[0].id}`}
