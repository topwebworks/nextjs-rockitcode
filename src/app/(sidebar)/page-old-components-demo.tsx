...
export const metadata: Metadata = {
  title: "RockitCode - UI Components Demo",
  description:
    "Showcase of all available UI components and design system elements for the RockitCode platform.",
};
    ...
    <>
      ...
      <div className="bg-blue-600 text-white py-4">
        <div className="text-center space-x-4">
          ...
          >
            🚀 Mobile-First Lesson System → Live Demo
          </a>
          ...
          <a 
            ...
            className="text-sm font-medium hover:text-blue-200 transition-colors"
          >
            🔧 Basic Monaco Test → Simple Editor
          </a>
          <span className="text-blue-200">|</span>
          <a 
            ...
            className="text-sm font-medium hover:text-blue-200 transition-colors"
          >
            ⚡ Enhanced Monaco → VSCode-like Features
          </a>
        </div>
      </div>
