...
import { useLearningContext } from '../app/(sidebar)/layout'
import { learningTracks } from '../data/lessons'
...
const mainNavigation = [
  {
    ...
    href: '/',
    icon: '🚀',
    description: 'Learn programming through video tutorials'
  },
  {
    id: 'courses',
    title: 'Courses',
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                <div className="text-sm font-medium text-gray-900 dark:text-white">
                  {learningContext.currentLesson?.title || 'Select a lesson'}
                </div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  {learningContext.currentTrack} • Lesson {learningContext.currentLessonIndex + 1}
                </div>
                <div className="mt-2">
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${((learningContext.currentLessonIndex + 1) / (learningTracks[currentSection]?.lessons?.length || 1)) * 100}%`
                      }}
                    ></div>
                  </div>
                </div>
