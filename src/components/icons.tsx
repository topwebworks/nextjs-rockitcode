...
// Building/Construction Icon - replaces 🏗️
...
// Mobile/Phone Icon - replaces 📱
export const MobileIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
...
export const RocketIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
      d="M15.818 7.182a8.5 8.5 0 010 9.636m-4.636 0a8.5 8.5 0 010-9.636m2.318-2.318a12 12 0 010 14.272M6.636 19.364a12 12 0 010-14.272" />
    <circle cx="12" cy="12" r="2" strokeWidth={1.5} />
  </svg>
)
...
// Code/Programming Icon - replaces 🐍 (for Python) or general coding
...
// Puzzle piece Icon - replaces 🧩
export const PuzzleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
      d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 011-1h1a2 2 0 100-4H7a1 1 0 01-1-1V7a1 1 0 011-1h3a1 1 0 001-1V4z" />
  </svg>
...
// Branch Icon - replaces 🌿
export const BranchIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
      d="M8 9l3 3-3 3m5 0h3M5 20h.01M5 16h.01M5 12h.01M5 8h.01M5 4h.01" />
  </svg>
)
...
export const RobotIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
      d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    <circle cx="9" cy="9" r="1" strokeWidth={1.5} />
    <circle cx="15" cy="9" r="1" strokeWidth={1.5} />
  </svg>
)

// Train/Speed Icon - replaces 🚄
export const TrainIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
      d="M13 10V3L4 14h7v7l9-11h-7z" />
  </svg>
...
// Graduation/Education Icon - replaces 🎓
...
// Triangle Icon - for Vercel/deployment
export const TriangleIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
...
// Discord Icon - for community links
...
// Users/Community Icon - for community features
...
// Chat/Message Icon - for chat/help features
...
// Heart Icon - for community love/support
...
// Help Circle Icon - for help center
export const HelpIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} 
...
export const renderIcon = (iconName: string, className?: string) => {
  ...
  switch (iconName) {
    ...
    case 'computer':
      return <ComputerIcon className={iconClass} />
    case 'mobile':
      return <MobileIcon className={iconClass} />
    case 'lightning':
    ...
    case 'branch':
      return <BranchIcon className={iconClass} />
    case 'robot':
      return <RobotIcon className={iconClass} />
    case 'train':
      return <TrainIcon className={iconClass} />
    case 'graduation':
      return <GraduationIcon className={iconClass} />
    case 'clock':
    ...
    case 'triangle':
      return <TriangleIcon className={iconClass} />
    case 'discord':
