...
const sections = [
  {
    name: 'Features',
    features: [
      { name: 'Edge content delivery', tiers: { Starter: true, Growth: true, Scale: true } as Record<TierName, boolean | string> },
      { name: 'Custom domains', tiers: { Starter: '1', Growth: '3', Scale: 'Unlimited' } as Record<TierName, boolean | string> },
      { name: 'Team members', tiers: { Starter: '3', Growth: '20', Scale: 'Unlimited' } as Record<TierName, boolean | string> },
      { name: 'Single sign-on (SSO)', tiers: { Starter: false, Growth: false, Scale: true } as Record<TierName, boolean | string> },
    ],
  },
  {
    name: 'Reporting',
    features: [
      { name: 'Advanced analytics', tiers: { Starter: true, Growth: true, Scale: true } as Record<TierName, boolean | string> },
      { name: 'Basic reports', tiers: { Starter: false, Growth: true, Scale: true } as Record<TierName, boolean | string> },
      { name: 'Professional reports', tiers: { Starter: false, Growth: false, Scale: true } as Record<TierName, boolean | string> },
      { name: 'Custom report builder', tiers: { Starter: false, Growth: false, Scale: true } as Record<TierName, boolean | string> },
    ],
  },
  {
    name: 'Support',
    features: [
      { name: '24/7 online support', tiers: { Starter: true, Growth: true, Scale: true } as Record<TierName, boolean | string> },
      { name: 'Quarterly workshops', tiers: { Starter: false, Growth: true, Scale: true } as Record<TierName, boolean | string> },
      { name: 'Priority phone support', tiers: { Starter: false, Growth: false, Scale: true } as Record<TierName, boolean | string> },
      { name: '1:1 onboarding tour', tiers: { Starter: false, Growth: false, Scale: true } as Record<TierName, boolean | string> },
    ],
  },
]
