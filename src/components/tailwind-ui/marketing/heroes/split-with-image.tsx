...
export default function SplitWithImageHero() {
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                Interactive coding lessons that adapt to your pace. Build real projects, solve coding challenges, and launch your tech career.
              </p>
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                <img
                  alt="App screenshot"
                  src="https://tailwindcss.com/plus-assets/img/app-screenshots/project-app-screenshot.png"
                  width={2432}
                  height={1442}
