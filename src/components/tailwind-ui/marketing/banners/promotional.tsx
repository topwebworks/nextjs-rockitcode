    ...
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-indigo-600 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      >
        <div
          style={{
            clipPath:
              'polygon(74.8% 41.9%, 97.2% 73.2%, 100% 34.9%, 92.5% 0.4%, 87.5% 0%, 75% 28.6%, 58.5% 54.6%, 50.2% 48.4%, 52.4% 44.1%, 45.2% 17.1%, 27.2% 0%, 0.9% 17.9%, 0% 27.9%, 11.9% 74.2%, 24.9% 54.1%, 68.6% 100%, 74.8% 41.9%)',
          }}
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm/6 text-white">
          <strong className="font-semibold">Early Bird Special</strong>
          <svg viewBox="0 0 2 2" aria-hidden="true" className="mx-2 inline h-0.5 w-0.5 fill-current">
            <circle r={1} cx={1} cy={1} />
          </svg>
          Get 30% off all courses this week only. Limited time offer!
        </p>
        <a
          href="#"
          className="flex-none rounded-full bg-white px-3.5 py-1 text-sm font-semibold text-indigo-600 shadow-sm hover:bg-gray-100"
        >
          Claim discount <span aria-hidden="true">&rarr;</span>
        </a>
      </div>
