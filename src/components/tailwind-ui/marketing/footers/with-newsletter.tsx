          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-gray-300">
                The fastest way to learn coding for any age. Master HTML/CSS, JavaScript, and Python with our interactive platform.
              </p>
            </div>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="xl:col-span-1">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-300">
                Get the latest coding tutorials and course updates.
              </p>
            </div>
            <form className="mt-6 sm:flex sm:max-w-md xl:col-span-2 xl:mt-0" onSubmit={handleSubmit}>
              ...
              <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Subscribe
                </button>
              </div>
