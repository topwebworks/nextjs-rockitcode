...
interface StatsWithBackgroundImageProps {
  eyebrow?: string
  headline?: string
  description?: string
...
export default function StatsWithBackgroundImage({
  ...
  headline = "Trusted by thousands of creators worldwide",
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <div
            ...
            className="aspect-1266/975 w-316.5 bg-linear-to-tr from-[#ff4694] to-[#776fff] opacity-20"
          />
        </div>
